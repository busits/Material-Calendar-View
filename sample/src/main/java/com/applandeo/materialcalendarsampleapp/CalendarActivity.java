...
public class CalendarActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        EventDay eventDayp=new EventDay(calendar);
        eventDayp.setColors(Arrays.asList(Color.RED,Color.GREEN,Color.BLUE,Color.RED,Color.GREEN,Color.BLUE));
        events.add(eventDayp);
